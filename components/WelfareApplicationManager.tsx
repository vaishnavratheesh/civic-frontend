...
const WelfareApplicationManager: React.FC<WelfareApplicationManagerProps> = ({ onApplicationUpdated }) => {
  const { user } = useAuth();
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Welfare Applications</h2>
        <p className="text-gray-600">
          {user?.role === 'admin' 
            ? 'Review and manage all welfare scheme applications across the panchayath' 
            : 'Review applications from your ward residents'
          }
        </p>
      </div>
...
export default WelfareApplicationManager; 